export const FAQS = [
  ...
  },
  {
    ...
    shortAnswer:
      "두 제도가 별개로 있고, 청약서에 모두 동의 항목이 있습니다. ① 「행정정보 공동이용」(전자정부법 §36, 별지 제61호, 12종) — 중앙회가 직접 조회. ② 「공공마이데이터」(전자정부법 §43조의2, 청약서 [선택]4번, 5종) — 정보주체가 국세청장에게 제공 요구. 두 항목 모두 동의 받으면 신분증·청구서·사유별 핵심 증빙(진단서·결정문 등)만 받으시면 됩니다.",
    sourceReference: { articles: ["행정정보 공동이용", "공공마이데이터"] },
  },
];
