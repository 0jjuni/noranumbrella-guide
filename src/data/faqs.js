export const FAQS = [
  ...
  },
  {
    ...
    shortAnswer:
      "「행정정보 공동이용 사전동의서」(별지 제61호, 2025.7.1 시행) 자필서명 시 12종이 자동 조회됩니다: 사업자등록증명 · 부가가치세과세표준증명 · 부가가치세면세사업자 수입금액증명 · 국내거소사실증명 · 주민등록표 등·초본 · 표준재무제표증명(법인/개인) · 폐업사실증명 · 연금보험료 등 소득·세액 공제확인서 · 외국인등록사실증명 · 출입국에 관한 사실증명 · 휴업사실증명. 신분증·청구서·사유별 핵심 증빙(진단서·결정문 등)만 받으시면 됩니다.",
